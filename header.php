            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 noPadd">
                ...
                <div id="ri-grid" class="ri-grid ri-grid-size-2"> <img class="ri-loading-image" src="<?php bloginfo( 'template_directory' ); ?>/images/loading.gif" />
                    <ul class="cb-slideshow">
                        <li><a href="#"><img src="<?php bloginfo( 'template_directory' ); ?>/images/thu-1.jpg" /></a></li>
                        <li><a href="#"><img src="<?php bloginfo( 'template_directory' ); ?>/images/thu-2.jpg" /></a></li>
                        <li><a href="#"><img src="<?php bloginfo( 'template_directory' ); ?>/images/thu-3.jpg" /></a></li>
                        <li><a href="#"><img src="<?php bloginfo( 'template_directory' ); ?>/images/thu-4.jpg" /></a></li>
                        <li><a href="#"><img src="<?php bloginfo( 'template_directory' ); ?>/images/thu-5.jpg" /></a></li>
                        <li><a href="#"><img src="<?php bloginfo( 'template_directory' ); ?>/images/thu-6.jpg" /></a></li>
                        <li><a href="#"><img src="<?php bloginfo( 'template_directory' ); ?>/images/thu-7.jpg" /></a></li>
                        <li><a href="#"><img src="<?php bloginfo( 'template_directory' ); ?>/images/thu-8.jpg" /></a></li>
                          <li><a href="#"><img src="<?php bloginfo( 'template_directory' ); ?>/images/thu-5.jpg" /></a></li>
                        <li><a href="#"><img src="<?php bloginfo( 'template_directory' ); ?>/images/thu-6.jpg" /></a></li>
                        <li><a href="#"><img src="<?php bloginfo( 'template_directory' ); ?>/images/thu-7.jpg" /></a></li>
                        <li><a href="#"><img src="<?php bloginfo( 'template_directory' ); ?>/images/thu-8.jpg" /></a></li>
